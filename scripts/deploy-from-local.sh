...
echo "   scp .next-build.tar.gz hostrootci@cpd-fi2.beyra.hostroot.ci:/home/hostrootci/public_html/beyra.hostroot.ci/"
echo ""
echo "📥 Then on the server, run:"
echo "   cd /home/hostrootci/public_html/beyra.hostroot.ci"
